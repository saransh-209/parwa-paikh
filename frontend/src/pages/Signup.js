  ...
  const FormContent = () => (
    <>
      ...
      <p style={{ textAlign: "center", fontSize: "11px", color: "#6b7280", lineHeight: 1.6 }}>
        ...
        <span style={{ color: "#a855f7", cursor: "pointer" }} onClick={() => toast.info("Terms of Service: Published content creator ki responsibility hai. Hate speech, copyright violation aur inappropriate content allowed nahi hai.")}>Terms of Service</span>
        {" "}and{" "}
        <span style={{ color: "#a855f7", cursor: "pointer" }} onClick={() => toast.info("Privacy Policy: Aapka data sirf platform use ke liye store hota hai. Hum aapka data kisi third party ko share nahi karte.")}>Privacy Policy</span>.
      </p>
    </>
  );
