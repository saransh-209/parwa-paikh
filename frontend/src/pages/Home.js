...
function Home() {
  ...
  // ✅ FIX: return is now INSIDE the function
  return (
                ...
                {showHistory && searchHistory.length > 0 && (
                  <div style={styles.historyBox}>
                    ...
                    <div style={styles.historyTop}>
                      ...
                      <span onClick={clearHistory} style={styles.clearX}>✕</span>
                    </div>
                    ...
                    >
                      <div style={styles.image}>
                        {post.image ? (
                          ...
                          <div style={styles.noImage}>No Cover</div>
                        )}
                      </div>

                      <div style={styles.cardBody(theme)}>
                        <h3 style={styles.postTitle(theme)}>{post.title}</h3>
                        <p style={styles.author(theme)}>✍ {post.author}</p>
                      </div>
        ...
        {showLogoutModal && (
          <div style={styles.overlay}>
            <div style={styles.modal}>
              ...
              <p style={{ color: '#dbeafe' }}>Do you really want to logout?</p>
...
const styles = {
  ...
  fullBgContainer: {
    ...
    backgroundImage: isMobile
      ? `linear-gradient(rgba(0,0,0,0.05), rgba(0,0,0,0.05)), url(${mobileBg})`
      : `url('https://res.cloudinary.com/djhio7kqd/image/upload/v1777919102/ChatGPT_Image_May_4_2026_11_47_57_PM_rsfpn5.png')`,
    backgroundSize: isMobile ? 'contain' : '100% auto',
  ...
  navbar: (theme) => ({
    ...
    height: '70px',
    flexWrap: 'wrap',
    background: theme === "dark" ? 'rgba(15, 23, 42, 0.72)' : 'rgba(226, 226, 207, 0.83)',
  ...
  headingLight: (theme) => ({
    fontSize: '45px',
    color: theme === "dark" ? "#1850ebc6" : "#193063d4",
  }),
  ...
  glass: {
    ...
    borderRadius: '28px',
    width: isMobile ? '275px' : '650px',
    maxWidth: isMobile ? '360px' : '700px',
    height: isMobile ? '390px' : '350px',
  ...
  // ✅ FIX: fontSize:45px; (invalid CSS) hataya
  heading: (theme) => ({
    fontSize: isMobile ? '48px' : '68px',
    marginBottom: '10px',
    lineHeight: '1.1',
    textAlign: 'center',
    color: theme === "dark" ? "#171f68" : "#0986e5f4",
  }),

  highlight: (theme) => ({
    display: 'block',
    marginTop: '10px',
    color: theme === "dark" ? "#c129b4" : "#4d2ab9e4",
  }),
  ...
  subtext: (theme) => ({
    ...
    lineHeight: '1.5',
    textAlign: 'center',
    color: theme === "dark" ? "#2d2d2d" : "#6a401ee2",
  }),
  ...
  sectionTitle: (theme) => ({
    fontSize: '40px',
    marginBottom: '30px',
    color: theme === "dark" ? "#16b4f3dc" : "#161515f3"
  }),
  ...
  card: (theme) => ({
    background: theme === "dark" ? "#258cedbd" : "#3b1d95dc",
    borderRadius: '12px',
    overflow: 'hidden',
    cursor: 'pointer'
  }),
  ...
  footer: (theme) => ({
    ...
    fontSize: '14px',
    textAlign: 'center',
    background: theme === "dark" ? "#08090bde" : "#c8d2f0ea",
    color: theme === "dark" ? "#fbfbfcbd" : "#0d0d0de8",
    marginTop: 'auto',
    fontWeight: '450',
    marginBottom: '0',
  }),
